...
public class AdapterListByUser extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListByUser(Context context, SelectedItem selectedItem) {
        mList = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)){
            case ITEM:
                ...
                dataVH.txtCreate.setText(dm.getCreate());
    ...
    */
    ...
    private class DataVH extends RecyclerView.ViewHolder {
        ...
        ImageView imgLogo;
        TextView txtJenis, txtCreate, txtArtis, txtJudul;
