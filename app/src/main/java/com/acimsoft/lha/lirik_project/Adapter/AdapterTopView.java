...
public class AdapterTopView extends RecyclerView.Adapter<AdapterTopView.holder> {

    List<DataModel> mlist;
    Context context;

    public AdapterTopView(Context context, List<DataModel> mlist) {
        this.mlist = mlist;
    ...
    @NonNull
    @Override
    public AdapterTopView.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new holder(LayoutInflater.from(parent.getContext())
        .inflate(R.layout.item_top_view, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterTopView.holder holder, int position) {
